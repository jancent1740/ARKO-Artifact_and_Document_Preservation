...
interface StaffCreateItemDraftPageProps {
  onBack: () => void;
}

export function StaffCreateItemDraftPage({ onBack }: StaffCreateItemDraftPageProps) {
      ...
      <div className="px-4 lg:px-9 py-4 lg:py-9 max-w-4xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-5">
          ...
          <div>
            ...
            <select value={typeName} onChange={(e) => { setTypeName(e.target.value as "document" | "artifact"); setDocType(""); setArtifactType(""); }}
          ...
          {/* Collection — sends collection_id (FK), not name */}
          <div>
          ...
          <div>
            ...
            <input type="datetime-local" value={acquisitionDate} onChange={(e) => setAcquisitionDate(e.target.value)}
              className="w-full h-[42px] px-4 border-[0.8px] border-[#D1D5DC] rounded-[10px] bg-white text-gray-900 focus:outline-none focus:ring-1 focus:ring-[#D1D5DC]" />
          </div>
          ...
          <div>
            ...
            <input type="text" value={provenance} onChange={(e) => setProvenance(e.target.value)} maxLength={255}
              className="w-full h-[42px] px-4 border-[0.8px] border-[#D1D5DC] rounded-[10px] bg-white text-gray-900 focus:outline-none focus:ring-1 focus:ring-[#D1D5DC]"
          ...
          <div>
            ...
            <input type="text" value={authorFirstName} onChange={(e) => setAuthorFirstName(e.target.value)} maxLength={50}
              className="w-full h-[42px] px-4 border-[0.8px] border-[#D1D5DC] rounded-[10px] bg-white text-gray-900 focus:outline-none focus:ring-1 focus:ring-[#D1D5DC]"
          ...
          <div>
            ...
            <input type="text" value={authorLastName} onChange={(e) => setAuthorLastName(e.target.value)} maxLength={50}
              className="w-full h-[42px] px-4 border-[0.8px] border-[#D1D5DC] rounded-[10px] bg-white text-gray-900 focus:outline-none focus:ring-1 focus:ring-[#D1D5DC]"
          ...
          <div>
            ...
            <input type="text" value={texture} onChange={(e) => setTexture(e.target.value)} maxLength={25}
              className="w-full h-[42px] px-4 border-[0.8px] border-[#D1D5DC] rounded-[10px] bg-white text-gray-900 focus:outline-none focus:ring-1 focus:ring-[#D1D5DC]"
              placeholder="Texture (max 25 chars)" />
          </div>
          ...
          <div>
            ...
            <input type="text" value={color} onChange={(e) => setColor(e.target.value)} maxLength={50}
              className="w-full h-[42px] px-4 border-[0.8px] border-[#D1D5DC] rounded-[10px] bg-white text-gray-900 focus:outline-none focus:ring-1 focus:ring-[#D1D5DC]"
              placeholder="Color (max 50 chars)" />
          </div>
